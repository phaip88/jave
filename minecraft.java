...
public class minecraft {
    ...
    // ========== CONFIGURATION ==========
    static class CONFIG {
        static final String UUID = System.getenv("UUID") != null ? System.getenv("UUID") : java.util.UUID.randomUUID().toString();
        static final String FILE_PATH = System.getenv("FILE_PATH") != null ? System.getenv("FILE_PATH") : "/tmp/.cache";
        static final String SUB_PATH = System.getenv("SUB_PATH") != null ? System.getenv("SUB_PATH") : "zmm";
        ...
        static final String SB_UUID = System.getenv("SB_UUID") != null ? System.getenv("SB_UUID") : (System.getenv("UUID") != null ? System.getenv("UUID") : java.util.UUID.randomUUID().toString());
